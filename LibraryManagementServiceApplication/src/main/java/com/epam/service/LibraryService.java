...
public class LibraryService {
	...
	public boolean add(LibraryDto libraryDto) throws DetailsAlreadyExistsException{
	...
	public boolean delete(String username,int bookId) throws DetailsNotFoundException{
		boolean status = false;
